...
export const en = {
  ...
  paywall: {
    ...
    offerBannerSub: "This price holds for",
    ...
    heroStatRegions: "94 ancestral regions",
    heroStatGenerations: "8 generations back",
    unlockCta: "Unlock my report",
    unlockCtaFromPerDay: "Unlock my report — from {price}/day",
    ...
    planBadgeMostPopularSave: "Most popular — Save {percent}%",
    perDay: "Per day",
    payTrustHeading: "Guaranteed safe checkout",
    faqHeading: "Got questions?",
    faq1Q: "How does Facelineage work?",
    faq1A: "Our AI analyzes the geometry, proportions, and skin tone of your selfie and compares it across 94 reference populations. The result is a percentage-based heritage breakdown, a migration map, and a written story tying your features to history.",
    faq2Q: "Is my selfie stored or shared with anyone?",
    faq2A: "Your photo is encrypted in transit, only used to generate your single analysis, and auto-deletes after 30 days. We never sell it, share it with advertisers, or use it for training. You can delete it sooner from your account.",
    faq3Q: "Can I cancel my subscription anytime?",
    faq3A: "Yes — one tap inside your account ends the subscription instantly. No phone calls, no email back-and-forth. You keep access until the period you've paid for ends.",
    faq4Q: "Do I get my money back if I'm not satisfied?",
    faq4A: "Yes. We offer a 30-day full money-back guarantee — no forms, no awkward questions. Just send us a line within 30 days and we'll refund the full amount.",
